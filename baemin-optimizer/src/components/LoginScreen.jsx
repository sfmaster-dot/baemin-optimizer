    ...
    <div style={S.root}>
      <div style={S.container}>
        <div style={S.logoWrap}>
          <img src='/favicon.png' alt='단꿈' style={S.logo} />
        </div>

        <h1 style={S.title}>단꿈 배달앱 최적화</h1>
        <p style={S.subtitle}>
...
const S = {
  ...
  // 단꿈 청록 로고 — 청록 그림자로 매칭
  logoWrap: { display:'inline-block', width:'80px', height:'80px', borderRadius:'20px', background:'#0f1110', boxShadow:'0 8px 32px rgba(0,179,164,.35)', marginBottom:'24px', overflow:'hidden', border:'1px solid #1f2424' },
