...
const PRESETS = {
  chicken: {
    ...
    notice:   { category:'치킨 전문점', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 치즈볼 4개 증정','2만원 이상 주문 시 콜라 1.25L 증정','신메뉴 출시 — 허니갈릭 치킨 20% 할인','우천 시 배달 10분 지연될 수 있습니다'] },
  ...
  chinese: {
    ...
    notice:   { category:'중국집', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 군만두 4개 증정','2인 세트 주문 시 탕수육 소자 증정','점심시간(11~13시) 세트 특가','매주 화요일 휴무입니다'] },
  ...
  donkatsu: {
    ...
    notice:   { category:'돈까스·일식', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 계란 장조림 증정','정식 세트 주문 시 미소장국 추가','매일 한정 20그릇 — 수제 돈까스','일요일 정기 휴무'] },
  ...
  pizza: {
    ...
    notice:   { category:'피자 전문점', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 콜라 1.25L 증정','L사이즈 주문 시 치즈스틱 증정','평일 점심 L 15% 할인','매주 월요일 휴무'] },
  ...
  fastfood: {
    ...
    notice:   { category:'수제버거', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 감자튀김 무료 추가','세트 주문 시 콜라 업그레이드','주말 한정 더블패티 할인','새벽 2시까지 영업합니다'] },
  ...
  jjim: {
    ...
    notice:   { category:'찜·탕 전문점', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 공깃밥 추가 증정','2인 주문 시 소주 1병 할인','해장국 아침 한정 10% 할인','매주 수요일 정기 휴무'] },
  ...
  jokbal: {
    ...
    notice:   { category:'족발 전문점', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 막국수 1인분 증정','대자 주문 시 소주 1병 할인','야식 시간(22시 이후) 10% 할인','새벽 3시까지 영업'] },
  ...
  bunsik: {
    ...
    notice:   { category:'분식 전문점', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 순대 1인분 증정','2만원 이상 주문 시 튀김 2개 증정','세트 메뉴 20% 할인','평일 오후 3시~5시 특가 타임'] },
  ...
  cafe: {
    ...
    notice:   { category:'카페', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 쿠키 1개 증정','음료 2잔 주문 시 디저트 20% 할인','매일 15시 이후 케이크 특가','신메뉴 출시 — 흑임자 라떼'] },
  ...
  korean: {
    ...
    notice:   { category:'한식 전문점', noticeType:['임시휴무','이벤트'], noticeDetail:['매주 일요일 정기 휴무입니다','리뷰 작성 시 계란후라이 추가 증정','정식 주문 시 반찬 1종 추가','점심 특가 운영 중 (11~14시)'] },
  ...
  gogi: {
    ...
    notice:   { category:'삼겹살 전문점', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 된장찌개 증정','2인 세트 주문 시 김치찌개 증정','매일 한정 30인분 — 숙성 삼겹살','주말 가족 세트 20% 할인'] },
  ...
  western: {
    ...
    notice:   { category:'양식 레스토랑', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 갈릭브레드 증정','런치 세트 20% 할인 (11~15시)','디너 2인 코스 예약 추천','매주 월요일 정기 휴무'] },
  ...
  asian: {
    ...
    notice:   { category:'아시안 음식점', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 짜조 2개 증정','쌀국수 주문 시 반미 20% 할인','신메뉴 — 팟타이 시즐러','매주 화요일 휴무'] },
  ...
  jokjang: {
    ...
    notice:   { category:'야식 전문점', noticeType:['이벤트','신메뉴출시'], noticeDetail:['리뷰 작성 시 먹태 1봉 증정','야식 시간(22~02시) 10% 할인','신메뉴 — 매운 불족발','새벽 4시까지 영업합니다'] },
  ...
  dosirak: {
    ...
    notice:   { category:'도시락 전문점', noticeType:'이벤트', noticeDetail:['리뷰 작성 시 계란후라이 추가 증정','주 5일 정기 주문 10% 할인','점심 특가 — 11~13시 배달비 할인','매주 일요일 휴무'] },
